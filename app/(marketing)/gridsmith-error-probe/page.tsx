 ...
 *
 * **Why it throws in an effect rather than during render.** A throw during SSR never
 * reaches this boundary — production serves Next's static `__next_error__` shell instead,
 * which is exactly how the untitled document shipped unnoticed. Only a throw *after*
 * hydration renders `global-error`. So: mount, set state in an effect, throw on the
 * re-render.
 *
