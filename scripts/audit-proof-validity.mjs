...
const REGISTER = [
  ...
  { id: 'G8', gate: 'check-bundle-size shared-baseline', source: 'A-GATE run 4 / A-GATE-4-3', outcome: 'green', validity: 'unestablished',
    ...
    note: 'UNREACHABLE probe. The floor check has an arithmetically identical predicate and exits ~70 lines earlier; the decomposition block never printed. Recorded as A-GATE-4-3, still open.' },
