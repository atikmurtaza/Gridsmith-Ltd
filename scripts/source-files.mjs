...
const NOT_SOURCE = {
  ...
  public: 'served verbatim, never bundled. `public/500.html` is a platform error document that must not reference the token layer — see M-P1-1 and the comment in that file',
