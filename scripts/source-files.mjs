...
const NOT_SOURCE = {
  ...
  '.next-press': 'ignored Press prototype build output — generated, not source',
  '.sanity': 'Sanity CLI runtime cache — generated, gitignored, never edited',
  '.vercel': 'Vercel CLI link state — generated by `vercel link`, gitignored, holds no source',
  docs: 'the specs. Prose, and their numbers are enforced by check-contrast, not here',
  node_modules: 'dependencies',
  // Excluded from the SOURCE walk, and NOT unscanned: `check-service-role-key` sweeps this
  // tree by its own path, every file and every extension, exactly as it sweeps
  // `.next/static/chunks`. The reason recorded here used to read "served verbatim, never
  // bundled" full stop, which is the argument for scanning it written as the argument
