...
| 2 | **Division routing** — ~~three cards~~ superseded at `GS-R001-M`: a typographic index of the three studios, no cards, no colour blocks (the owner rejected the cards at `GS-O008`) | Route (M-J3) | → division hub |
