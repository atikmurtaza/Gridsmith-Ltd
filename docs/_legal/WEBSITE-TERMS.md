...
This site is operated by **Gridsmith Ltd**, a company registered in England & Wales, company number `[TK]`, registered office `[TK]`. VAT number `[TK, where registered]`.
...
Subject to that, and to the extent permitted by law, we exclude liability for loss arising from use of this site, including loss of profit, business, data or goodwill, and any indirect or consequential loss.
...
**`[TK]` items:** company number, registered office, VAT number, contact email and phone, effective date.
