...
5. **Contrast constraints** — division accents used only where the spec permits. Amber on white (2.0:1) and `--line-strong` (2.1–2.4:1) may never be text or a sole state indicator
